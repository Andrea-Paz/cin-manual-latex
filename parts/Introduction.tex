...
redistribute, and modify (except for \textit{invariant sections}) a work and requires all copies and derivatives to be available under the same license.
...
\begin{description}
    ...
    \item[Appendix \ref{cha:developer_section}] \nameref{cha:developer_section}.
